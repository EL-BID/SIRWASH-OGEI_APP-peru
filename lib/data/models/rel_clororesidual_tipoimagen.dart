...
class RelCloroResidualTipoImagen {
  final int imagenId;
  final String nombre;
  final String ruta;
  ...
  RelCloroResidualTipoImagen copyWith({
  ...
  factory RelCloroResidualTipoImagen.fromSQLite(Map<String, dynamic> json) =>
      RelCloroResidualTipoImagen(
