...
class RelComponenteSapTipoImagen {
  final int imagenId;
  final String nombre;
  final String ruta;
  ...
  RelComponenteSapTipoImagen copyWith({
  ...
  factory RelComponenteSapTipoImagen.fromSQLite(Map<String, dynamic> json) =>
      RelComponenteSapTipoImagen(
