...
class FileMgr {
  ...
  Future<PathHandler> getLocalPathHandler(String subdir) async {
    ...
    if (!exists) {
      _log.i("Creating directory $result");
  ...
  Future<void> ungzipAbsolute(String zippedFilename, String filename) async {
    _log.i("Un-G-zipping $zippedFilename to $filename");
  ...
  Future<void> unzipAbsolute(
    ...
    for (ArchiveFile file in archive) {
      if (file.isFile) {
        _log.i("Unzipping ${file.name} to $destinationDirectory/${file.name}");
